    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'name_contact_person' => 'nullable|string',
            ]);
            ...
            $param1 = $request->address_type;

            // Cek apakah sudah ada data dengan personal_data_id yang sama
            $existingData = $this->model->where('personal_data_id', $personalDataId)->where('address_type',$param1)->first();
